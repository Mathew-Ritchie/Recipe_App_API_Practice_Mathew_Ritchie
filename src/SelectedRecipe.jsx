...
export default function SelectedRecipe() {
  ...
  return (
    <div className=" max-w-4xl mx-auto text-center bg-yellow-50 pt-5">
      ...
      <h2 className="text-3xl font-bold mb-4 mt-4 text-start pl-5">Instructions:</h2>
      <p className="text-lg text-gray-700 text-start px-5">{selectedRecipe.strInstructions}</p>
      <div className="mt-8">
        <a
